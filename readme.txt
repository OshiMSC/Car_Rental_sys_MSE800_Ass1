...
4. Setup Instructions
    Clone the Repository:
        ...
        git clone https://github.com/OshiMSC/Car_Rental_sys_MSE800_Ass1.git
        cd Car_Rental_sys_MSE800_Ass1
        ...
        pip install Flask==2.3.5 Werkzeug==2.3.7

        Note: sqlite3 and datetime are part of Python’s standard library, so no additional installation is required.
        Bootstrap and FullCalendar are included via CDN in HTML files.
